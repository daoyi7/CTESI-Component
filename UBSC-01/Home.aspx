...
<head runat="server">
    ...
    <script type="text/javascript" src="resource/js/changeMi.js"></script>
...
//            doc.getElementById('divMap').innerHTML = li.object.map || li.object.title;
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            var tp = document.querySelector('.top_right');
            //console.log(tp);
            var tp_ch = tp.childNodes;
            for (var i = 0 in tp_ch) { 
                if (tp_ch[i].nodeName == "#text" && !/\S/.test(tp_ch[i].nodeValue)) {
                    tp.removeChild(tp_ch[i]);
                }
            };
            var firstImg = tp.children[1];
            firstImg.firstChild.src='images/OA/refresh.png';
            var secondImg=tp.childNodes[2];
            secondImg.firstChild.src='images/OA/logout.png';
            var thirdImg=tp.childNodes[3];
            thirdImg.firstChild.src='images/OA/myjob.png';
            var fImg=tp.childNodes[4];
            fImg.firstChild.src='images/OA/changePW.png';
            var tF=tp.childNodes[5];
            tF.firstChild.src='images/OA/help.png';
            var tS=tp.childNodes[6];
            tS.firstChild.src='images/OA/suOut.png';
        }
