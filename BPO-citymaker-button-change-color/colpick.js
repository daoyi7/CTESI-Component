	...
	var colpick = function () {
		var
			...
			clickSubmit = function (ev) {
                ...
                $(".color_itemBtn").eq(cal.index()-2).css("background",cal.find(".colpick_new_color").css("backgroundColor"));
			...
			init: function (opt) {
				...
				return this.each(function () {
					...
					if (!$(this).data('colpickId')) {
						...
						options.currentColor = $(this).parent().find('.color_itemBtn');
						// console.log($(this).parent().find(".color_itemBtn"))
